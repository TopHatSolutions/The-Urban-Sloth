...
class PromotionsControllerTest < ActionController::TestCase
  ...
  test "should create promotion" do
    assert_difference('Promotion.count') do
      post :create, promotion: { date_end: @promotion.date_end, date_start: @promotion.date_start, description: @promotion.description, name: @promotion.name }
    end
  ...
  test "should update promotion" do
    patch :update, id: @promotion, promotion: { date_end: @promotion.date_end, date_start: @promotion.date_start, description: @promotion.description, name: @promotion.name }
    assert_redirected_to promotion_path(assigns(:promotion))
  end
