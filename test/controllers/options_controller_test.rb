...
class OptionsControllerTest < ActionController::TestCase
  ...
  test "should create option" do
    assert_difference('Option.count') do
      post :create, option: { option_price: @option.option_price, option_type: @option.option_type, option_value: @option.option_value }
    end
  ...
  test "should update option" do
    patch :update, id: @option, option: { option_price: @option.option_price, option_type: @option.option_type, option_value: @option.option_value }
    assert_redirected_to option_path(assigns(:option))
  end
