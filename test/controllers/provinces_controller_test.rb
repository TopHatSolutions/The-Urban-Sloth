...
class ProvincesControllerTest < ActionController::TestCase
  ...
  test "should create province" do
    assert_difference('Province.count') do
      post :create, province: { abbreviation: @province.abbreviation, gst_rate: @province.gst_rate, hst_rate: @province.hst_rate, name: @province.name, pst_rate: @province.pst_rate }
    end
  ...
  test "should update province" do
    patch :update, id: @province, province: { abbreviation: @province.abbreviation, gst_rate: @province.gst_rate, hst_rate: @province.hst_rate, name: @province.name, pst_rate: @province.pst_rate }
    assert_redirected_to province_path(assigns(:province))
  end
